...
[![Documentation](https://docs.rs/aws_lambda_events/badge.svg?version=0.2.5)](https://docs.rs/aws_lambda_events/0.2.5)
...
For a list of supported AWS Lambda events and services, see [the crate reference documentation](https://docs.rs/aws_lambda_events/0.2.5).
